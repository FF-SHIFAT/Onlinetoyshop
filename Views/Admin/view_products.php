...
<head>
    ...
    <style>
        ...
        .controls-bar {
            ...
            padding: 15px; border-radius: 8px; margin-bottom: 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); flex-wrap: wrap; gap: 10px;
        }

        .filter-group { display: flex; align-items: center; gap: 10px; }
        .control-input { padding: 8px 12px; border: 1px solid #ddd; border-radius: 5px; outline: none; }
        .btn-go { background: #343a40; color: white; border: none; padding: 8px 15px; border-radius: 5px; cursor: pointer; }
        
        .btn-add-new { background: #1abc9c; color: white; padding: 10px 15px; border: none; cursor: pointer; border-radius: 5px; font-weight: bold; text-decoration: none; display: inline-block; }
        .btn-add-new:hover { background: #16a085; }
        ...
        .btn-action { padding: 5px 10px; border-radius: 4px; color: white; text-decoration: none; font-size: 12px; margin-right: 5px; cursor: pointer; border:none; }
        .btn-view { background: #3498db; }
        .btn-edit { background: #f39c12; }
        .btn-delete { background: #e74c3c; }

        .modal { display: none; position: fixed; z-index: 1100; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.6); overflow: hidden; }
        .modal-content { background-color: white; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 25px; border-radius: 10px; width: 50%; max-width: 600px; max-height: 85vh; overflow-y: auto; }
        .close-btn { position: sticky; top: 0; float: right; font-size: 30px; font-weight: bold; color: #aaa; cursor: pointer; background: white; width: 100%; text-align: right; z-index: 100; padding-bottom: 10px; }
        .desc-box { background-color: #f8f9fa; border: 1px solid #e9ecef; padding: 15px; border-radius: 6px; max-height: 150px; overflow-y: auto; font-size: 14px; color: #555; white-space: pre-wrap; }
    </style>
</head>
<body>
    ...
    <div class="admin-container">
        <div class="sidebar">
            ...
            <a href="view_products.php" class="active">Manage Products</a>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="../../Resources/Products/<?php echo $row['image']; ?>" width="40" style="vertical-align:middle; border-radius: 4px;"> <?php echo $row['name']; ?></td>
                        <td><?php echo $row['cat_name']; ?></td>
                        <td>Tk. <?php echo $row['price']; ?></td>
                        <td><?php echo ($row['stock'] > 0) ? "<span style='color:green; font-weight:bold;'>{$row['stock']}</span>" : "<span style='color:red; font-weight:bold;'>Out</span>"; ?></td>
                        <td>
